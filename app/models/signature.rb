...
class Signature < ActiveRecord::Base
  ...
  AUTOGENERATED_EMAIL = /\Asignature-\d+-[a-z0-9]{4}@example\.com\z/
  ...
  before_validation if: :autogenerate_email do
    self.email = EmailGenerator.call(petition.signature_count + 1)
  end
  ...
  attr_reader :autogenerate_email

  def autogenerate_email=(value)
    @autogenerate_email = value.present?
  end

  def autogenerated_email?
    email.match?(AUTOGENERATED_EMAIL)
  end
